		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#chmoblchmuryobliczeniowe-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"chmoblchmuryobliczeniowe-display": {
								"semanticObject": "chmoblchmuryobliczeniowe",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=chm.obl.chmuryobliczeniowe",
									"url": sap.ui.require.toUrl("chm/obl/chmuryobliczeniowe")
								}
							}
						}
					}
